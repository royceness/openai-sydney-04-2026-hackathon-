  ...
  const tools = useMemo(
    () => [
      ...
      defineVoiceTool({
        ...
        description: "Search already-loaded Review Room thread titles and Markdown text using simple case-insensitive text matching. Only use this when the user explicitly asks to search existing threads or prior answers. Do not use this for repository research requests like finding tests, callers, usages, or coverage; create a Codex thread instead.",
        parameters: z.object({
