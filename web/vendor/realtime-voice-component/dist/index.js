...
function normalizeToolSchema(schema) {
  return stripSchemaMetadata(toJSONSchema(schema));
}
...
function GhostCursorOverlay({ state, className }) {
  const renderCursor = (cursor) => /* @__PURE__ */ jsxs(
    "div",
    {
      "aria-hidden": "true",
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "vc-ghost-cursor__halo" }),
        /* @__PURE__ */ jsx("span", { className: "vc-ghost-cursor__trail" }),
        /* @__PURE__ */ jsx("span", { className: "vc-ghost-cursor__pointer", children: /* @__PURE__ */ jsx("span", { className: "vc-ghost-cursor__core" }) })
      ]
    },
    cursor.id
  );
...
function useGhostCursor({
  ...
  const trackedPointerRef = useRef2(null);
  const scriptedPointerRef = useRef2(null);
  ...
  const resolveOrigin = useCallback((from = "pointer") => {
  ...
  const enqueueRun = useCallback((run2) => {
...
function useCornerSnap({
  ...
  const [rootNode, setRootNode] = useState2(null);
  ...
  const sizeRef = useRef3(fallbackSize);
  const cornerRef = useRef3(corner);
  const positionRef = useRef3(position);
  const dragSessionRef = useRef3(null);
  const pointerHistoryRef = useRef3([]);
  const animationFrameRef = useRef3(null);
  const animationRef = useRef3(null);
  const lastWidgetIdRef = useRef3(widgetId);
  const suppressLauncherClickRef = useRef3(false);
  const rootRef = useCallback2((node) => {
    sizeRef.current = readWidgetSize(node, sizeRef.current);
    setRootNode(node);
  }, []);
  const getWidgetSize = useCallback2(() => {
    sizeRef.current = readWidgetSize(rootNode, sizeRef.current);
    return sizeRef.current;
  }, [rootNode]);
  const getWidgetPosition = useCallback2(() => {
    positionRef.current = readWidgetPosition(rootNode, positionRef.current);
    return positionRef.current;
  }, [rootNode]);
  const setCornerState = useCallback2((nextCorner) => {
    cornerRef.current = nextCorner;
    setCorner(nextCorner);
  }, []);
  const setPositionState = useCallback2((nextPosition) => {
    positionRef.current = nextPosition;
    setPosition(nextPosition);
  }, []);
  const setClampedPositionState = useCallback2(
    (nextPosition) => {
  ...
  const snapToCorner = useCallback2(
    (nextCorner) => {
  ...
  const stepAnimation = useCallback2(
    (now) => {
  ...
  const ensureAnimationLoop = useCallback2(() => {
    if (animationFrameRef.current !== null) {
      cancelAnimationFrame(animationFrameRef.current);
    }
    animationFrameRef.current = requestAnimationFrame(stepAnimation);
  }, [stepAnimation]);
  const startAnimationToCorner = useCallback2(
  ...
  const animateToNearestCorner = useCallback2(
    (from, velocity) => {
  ...
  const measureAndResnap = useCallback2(() => {
    if (!enabled || !rootNode) {
      return;
    }
  ...
  const consumeLauncherClickSuppression = useCallback2(() => {
    const shouldSuppress = suppressLauncherClickRef.current;
    suppressLauncherClickRef.current = false;
    return shouldSuppress;
  }, []);
  const getHandleProps = useCallback2(
    (handleKind) => ({
      onPointerDown: (event) => {
...
var useIsomorphicLayoutEffect2 = typeof window === "undefined" ? useEffect4 : useLayoutEffect2;
function useViewportMatch(maxWidth) {
  ...
  return useSyncExternalStore2(subscribe, getSnapshot, () => false);
}
...
function renderLauncherIndicatorIcon(visualState, unstyled) {
  switch (visualState) {
    ...
    case "error":
      return /* @__PURE__ */ jsxs2("svg", { "aria-hidden": "true", viewBox: "0 0 16 16", children: [
        /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "11.75", fill: "currentColor", r: "1" }),
        /* @__PURE__ */ jsx2(
          "path",
          {
            d: "M8 3.25v5.75",
    ...
    case "live":
      return /* @__PURE__ */ jsxs2("svg", { "aria-hidden": "true", viewBox: "0 0 16 16", children: [
        /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "8", fill: "currentColor", r: "3.25" }),
        /* @__PURE__ */ jsx2(
          "circle",
          {
            cx: "8",
    ...
    default:
      return /* @__PURE__ */ jsx2("svg", { "aria-hidden": "true", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsx2(
        "path",
        {
...
function renderLauncherHandleIcon() {
  return /* @__PURE__ */ jsxs2("svg", { "aria-hidden": "true", viewBox: "0 0 12 24", children: [
    /* @__PURE__ */ jsx2("circle", { cx: "4", cy: "3.75", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "3.75", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "4", cy: "9.25", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "9.25", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "4", cy: "14.75", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "14.75", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "4", cy: "20.25", fill: "currentColor", r: "1.1" }),
    /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "20.25", fill: "currentColor", r: "1.1" })
  ] });
}
function VoiceControlWidget({
  ...
  const dragPositionRef = useRef4({ x: 0, y: 0 });
  const suppressLauncherClickRef = useRef4(false);
  const launcherToastTimeoutRef = useRef4(null);
  const [position, setPosition] = useState3({ x: 0, y: 0 });
  const [dragging, setDragging] = useState3(false);
  const [launcherToastMessage, setLauncherToastMessage] = useState3(null);
  const [portalContainer, setPortalContainer] = useState3(null);
  const setWidgetPosition = useCallback3((nextPosition) => {
  ...
  const widgetRoot = /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        launcherToastMessage ? /* @__PURE__ */ jsx2(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs2(
          "div",
          {
            ...
            children: [
              ...
              draggableInLayout ? /* @__PURE__ */ jsxs2(Fragment2, { children: [
                /* @__PURE__ */ jsx2(
                  "span",
                  {
  ...
  const snapOverlay = /* @__PURE__ */ jsx2(
    "div",
    {
